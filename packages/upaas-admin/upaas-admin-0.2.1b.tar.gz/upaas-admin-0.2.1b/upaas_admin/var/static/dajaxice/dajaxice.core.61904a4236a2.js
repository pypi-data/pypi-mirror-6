...
var Dajaxice = {
    ...
    instances: function(callback_function, argv, custom_settings){
        return Dajaxice.call('upaas_admin.apps.applications.instances', 'POST', callback_function, argv, custom_settings);
    },

    apps_updates: function(callback_function, argv, custom_settings){
        return Dajaxice.call('upaas_admin.apps.applications.apps_updates', 'POST', callback_function, argv, custom_settings);
    },

    task_messages: function(callback_function, argv, custom_settings){
        return Dajaxice.call('upaas_admin.apps.applications.task_messages', 'POST', callback_function, argv, custom_settings);
    }
