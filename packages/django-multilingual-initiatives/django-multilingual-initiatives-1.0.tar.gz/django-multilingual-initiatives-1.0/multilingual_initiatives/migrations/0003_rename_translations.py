...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        raise RuntimeError('Old simple_translations models cannot be restored. No backwards migration provided.')
        # Removing unique constraint on 'InitiativeTranslation', fields ['language_code', 'master']
        db.delete_unique(u'multilingual_initiatives_initiative_translation', ['language_code', 'master_id'])
    ...
    models = {
        ...
        u'multilingual_initiatives.initiativepersonrole': {
        ...
        u'multilingual_initiatives.initiativepluginmodel': {
            'Meta': {'object_name': 'InitiativePluginModel', '_ormbases': ['cms.CMSPlugin']},
        ...
        u'multilingual_initiatives.initiativetranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'InitiativeTranslation', 'db_table': "u'multilingual_initiatives_initiative_translation'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['multilingual_initiatives.Initiative']"}),
