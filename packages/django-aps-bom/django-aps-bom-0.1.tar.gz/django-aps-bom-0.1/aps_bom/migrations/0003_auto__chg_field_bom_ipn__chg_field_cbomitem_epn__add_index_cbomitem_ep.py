...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'CBOMItem.epn' to match new field type.
        db.rename_column(u'aps_bom_cbomitem', 'epn', 'epn_id')
        # Changing field 'CBOMItem.epn'
        db.alter_column(u'aps_bom_cbomitem', 'epn_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aps_bom.EPN']))
        # Adding index on 'CBOMItem', fields ['epn']
        db.create_index(u'aps_bom_cbomitem', ['epn_id'])


    def backwards(self, orm):
        # Removing index on 'CBOMItem', fields ['epn']
        db.delete_index(u'aps_bom_cbomitem', ['epn_id'])


        # Changing field 'BOM.ipn'
        db.alter_column(u'aps_bom_bom', 'ipn_id', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['aps_bom.IPN']))

        # Renaming column for 'CBOMItem.epn' to match new field type.
        db.rename_column(u'aps_bom_cbomitem', 'epn_id', 'epn')
        # Changing field 'CBOMItem.epn'
        db.alter_column(u'aps_bom_cbomitem', 'epn', self.gf('django.db.models.fields.CharField')(max_length=50))
