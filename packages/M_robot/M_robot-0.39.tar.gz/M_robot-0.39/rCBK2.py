...
tracking = True
zoznamBodov = np.array([(1,1),(10,-120),(200,-230),(320,-100),(-200,100),(-210,-400),(200,-450),(1,1),(10,-120)])
#zoznamBodov = np.array([(9,179),(45,8),(74,182)])
...
def init():#inicializacna funkcia kvoli animacii
    ...
    line7.set_data([], [])
    track.set_data([],[])
    return line2,line3,line4,line5,line6,line7,line,track,
...
def vykresliRobota(i):
    ...
    if(changed==True):
        track_xdata.append(robot.astred[0])
        track_ydata.append(robot.astred[1])
        ...
        if(tracking==True):
        	track.set_data(track_xdata,track_ydata)
...
track, = ax.plot([], [], lw=2, color = 'black')
#naplnenie zoznamov
