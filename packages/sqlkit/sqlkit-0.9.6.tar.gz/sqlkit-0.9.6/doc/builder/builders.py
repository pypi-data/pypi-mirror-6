## origginally found in sphinx docs of sqlalchemy by Michael Bayer.
## modified by Alessandro Dentella to use templates_map
...
class MakoBridge(TemplateBridge):
    ...
    def init(self, builder, *args, **kw):
        ...
        self._map = builder.config.templates_map
    ...
    def render(self, template, context):
        ...
        context['mako_layout'] = self._map.get(context.get('current_page_name'), 'layout.mako')
