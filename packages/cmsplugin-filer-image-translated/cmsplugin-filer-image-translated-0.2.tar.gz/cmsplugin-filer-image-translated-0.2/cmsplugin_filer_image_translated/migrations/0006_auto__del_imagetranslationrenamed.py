...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ImageTranslationRenamed'
        db.delete_table('cmsplugin_filer_image_translated_imagetranslationrenamed')


    def backwards(self, orm):
        # Adding model 'ImageTranslationRenamed'
        db.create_table('cmsplugin_filer_image_translated_imagetranslationrenamed', (
            ('trans_description', self.gf('django.db.models.fields.TextField')(max_length=256, blank=True)),
            ('trans_name', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('trans_caption', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trans_alt_text', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
        ))
        db.send_create_signal('cmsplugin_filer_image_translated', ['ImageTranslationRenamed'])
