...
from functions import first, identity, keys, last, merge, rest
...
def query(db, sql_and_params, as_arrays=False, identifiers=op.methodcaller('lower'),
          result_set_fn=tuple, row_fn=identity):
