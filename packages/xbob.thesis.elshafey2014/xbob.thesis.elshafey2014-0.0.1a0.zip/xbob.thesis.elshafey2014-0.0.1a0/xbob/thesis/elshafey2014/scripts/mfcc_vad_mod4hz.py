...
def command_line_arguments(command_line_parameters):
  ...
  parser.add_argument('-p', '--preprocessing', default = 'xbob/thesis/elshafey2014/configurations/audio/mod_4hz.py', help = 'Audio preprocessing configuration.')
  # - the features configuration
  parser.add_argument('-f', '--features', default = 'xbob/thesis/elshafey2014/configurations/audio/mfcc_60.py', help = 'Feature extraction configuration.')
...
def main(command_line_parameters = sys.argv):
  ...
  print("Executing MFCC feature extraction with modulo 4Hz VAD.")
  ...
  command = [
              ...
              '-f', args.features,
              '-t', 'xbob/thesis/elshafey2014/configurations/audio/isv_512g_u200.py',
