...
## change the Creator.__set__ behavior, this idea was inspired by 
...
class Creator(object):
    ...
    def __set__(self, obj, value):
        # this function is modefied to call pre_init insted of to_python
        # so that we can tell if the object need deserialization or not
