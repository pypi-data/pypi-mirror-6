...
* :ref:`Synchrotron sources <synchrotron-sources>`. Bending magnet, wiggler,
  ...
  the section :ref:`comparison-synchrotron-sources` for the comparison between
...
* *Energy dispersive elements*. Implemented are :meth:`crystals in dynamical
  ...
  <xrt.backends.raycing.materials.run_tests>`, xrt works correctly for
  asymmetric crystals in transmission regime.
...
* *Materials*. The material properties are incorporated using :class:`three
  ...
  scattering factors, with a wide energy range (>100 keV) or finer energy mesh.
  Refraction index and absorption coefficient are calculated from the
...
__module__ = "xrt"
__author__ = \
    "Konstantin Klementiev (MAX IV)", "Roman Chernikov (DESY Photon Science)"
