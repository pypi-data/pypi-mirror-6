...
def main():
  ...
  parser.add_argument('--' + __CHARTSET, default='utf-8',
                      help='Log file charset. Default is utf-8.')
  ...
  parser.add_argument('-v', '--' + __VERBOSE, default=False, action='store_true', help='Verbose mode.')
  ...
  print('  {0} => {1}'.format(__CHARTSET, args.charset))
