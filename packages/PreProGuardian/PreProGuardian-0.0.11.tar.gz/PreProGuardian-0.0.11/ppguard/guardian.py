...
class Guardian(object):
	...
	def run(self):
		...
		commands = []
		for command in list(itertools.chain.from_iterable([c(self.config, self.sources_root, self.static_root).commands() for c in watchers])):
