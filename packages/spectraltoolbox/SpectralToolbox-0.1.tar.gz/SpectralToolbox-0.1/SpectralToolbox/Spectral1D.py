...
__revision__ = filter(str.isdigit, "$Revision: 117 $")
...
AVAIL_QUADPOINTS = [GAUSS, GAUSSRADAU, GAUSSLOBATTO]
...
class Poly1D(object):
    ...
    def __init__(self,poly,params,sdout=sys.stderr):
        ...
        if (poly in AVAIL_POLY):
            ...
            print >> self.sdout, "The inserted type of polynomial is not available."
            return
        self.poly = poly
        self.params = params
