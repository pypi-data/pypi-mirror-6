...
from backtalk.models import Comment
from backtalk.forms import CommentForm


DEFAULT_COMMENTS_APP = 'backtalk'

def get_comment_app():
    """
    Get the comment app (i.e. "foo.backtalk") as defined in the settings
    """
...
def get_form_target():
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_form_target"):
        ...
        return urlresolvers.reverse("backtalk.views.comments.post_comment")
...
def get_flag_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_flag_url"):
        ...
        return urlresolvers.reverse("backtalk.views.moderation.flag",
                                    args=(comment.id,))
...
def get_delete_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_delete_url"):
        ...
        return urlresolvers.reverse("backtalk.views.moderation.delete",
                                    args=(comment.id,))
...
def get_approve_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_approve_url"):
        ...
        return urlresolvers.reverse("backtalk.views.moderation.approve",
                                    args=(comment.id,))
