...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for trans in orm['multilingual_orgs.OrganizationTranslationRenamed'].objects.all():
            orm['multilingual_orgs.OrganizationTranslation'].objects.create(
                master=trans.organization,
