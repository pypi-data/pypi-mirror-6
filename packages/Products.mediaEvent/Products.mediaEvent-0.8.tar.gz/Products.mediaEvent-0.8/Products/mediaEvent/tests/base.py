...
def setup_product():
    ...
    import Products.mediaEvent
    zcml.load_config('configure.zcml', Products.mediaEvent)
    ...
    ztc.installPackage('Products.mediaEvent')
...
setup_product()
ptc.setupPloneSite(products=['Products.mediaEvent'])
