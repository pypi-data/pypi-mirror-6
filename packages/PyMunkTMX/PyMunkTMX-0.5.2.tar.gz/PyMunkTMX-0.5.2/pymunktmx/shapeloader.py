...
def load_circle(tmxobject, map_height, static_body):
    """
...
def load_poly(tmxobject, map_height, static_body):
    ...
    :return: A pymunk.Poly shape instance.
    """
    return load_poly_convex(tmxobject, map_height, static_body)


def load_poly_convex(tmxobject, map_height, static_body):
    """
    Creates a pymunk.Poly parsed from a TiledObject instance.
...
def load_poly_concave(tmxobject, map_height, static_body):
    """
    Placeholder for loading a convex shape and nreaking it down into
    several concave shapes.
...
def load_shapes(tmxdata, space=None, default_layers=-1):
    ...
    :param int default_layers: If the layers property of a shape is not set \
    ...
    for o, t in objects:
        ...
        if t == "pymunktmx_box":
            ...
            shape = load_circle(o, map_height, static_body)
