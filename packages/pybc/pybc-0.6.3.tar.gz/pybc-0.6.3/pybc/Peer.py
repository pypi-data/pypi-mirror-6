...
import random, time, threading, logging, socket
        ...
        with self.lock:
            if (len(self.connections) > 2 * self.optimal_connections and 
                ...
                if connection.incoming:
                    ...
                    self.incoming_hosts.add(connection.transport.getPeer()[0])
    ...
    def lost_connection(self, connection):
        ...
        with self.lock:
            ...
            if connection.incoming:
                ...
                self.incoming_hosts.discard(connection.transport.getPeer()[0])
