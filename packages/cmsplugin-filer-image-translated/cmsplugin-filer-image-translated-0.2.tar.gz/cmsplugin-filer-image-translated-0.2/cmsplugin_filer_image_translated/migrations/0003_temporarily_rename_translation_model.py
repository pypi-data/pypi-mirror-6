...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'cmsplugin_filer_image_translated_imagetranslation', u'cmsplugin_filer_image_translated_imagetranslationrenamed')

    def backwards(self, orm):
        db.rename_table(u'cmsplugin_filer_image_translated_imagetranslationrenamed', u'cmsplugin_filer_image_translated_imagetranslation')
