...
import struct, hashlib, traceback, time, threading, logging, itertools, sys
...
class CoinState(State):
    ...
    def apply_transaction(self, transaction):
        ...
        for i, output in enumerate(transaction.outputs):
            ...
            if self.has_unused_output(unused_output):
                loging.error("Trying to create duplicate output: {} {} {} "
    ...
    def step_backwards(self, block):
        ...
        for transaction_bytes in reversed(list(transactions.unpack_transactions(
            block.payload))):
