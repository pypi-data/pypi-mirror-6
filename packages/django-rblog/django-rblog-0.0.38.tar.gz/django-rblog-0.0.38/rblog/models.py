...
class Post(models.Model):
    ...
    tags = TagField()
    image = models.ImageField(_(u'Image'), upload_to='images/posts', blank=True)
    ...
    thread_id = models.CharField(_(u'Disqus thread id'), max_length=32, blank=True) # DISQUS
    lang = models.CharField(_(u'Language of the post'), max_length=32, blank=True, null=True)
