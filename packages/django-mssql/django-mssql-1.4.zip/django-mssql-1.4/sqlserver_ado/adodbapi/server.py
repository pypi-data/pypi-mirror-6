...
import sqlserver_ado.adodbapi.adodbapi
...
#        if item.startswith('_pyro'):
#            raise AttributeError  # let local Pyro know this object is not remote here
#        return self.get_attribute_for_remote(item)
...
def serve():
    ...
    print("use HOST=nnn and PORT=nnn to change interface addresses")
