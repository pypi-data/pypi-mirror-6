...
setup(
    ...
    install_requires=[u'reahl-component>=2.0,<2.1', u'reahl-interfaces>=2.0,<2.1', u'slimit>=0.8,<0.9', u'cssmin>=0.1,<0.2', u'BeautifulSoup>=3.2,<3.3', u'webob>=1.2,<1.3', u'Babel>=0.9,<0.10'],
    setup_requires=[],
    tests_require=[u'reahl-tofu>=2.0,<2.1', u'reahl-stubble>=2.0,<2.1', u'reahl-sqlalchemysupport>=2.0,<2.1', u'reahl-web-elixirimpl>=2.0,<2.1', u'reahl-domain>=2.0,<2.1', u'reahl-dev>=2.0,<2.1', u'reahl-webdev>=2.0,<2.1'],
