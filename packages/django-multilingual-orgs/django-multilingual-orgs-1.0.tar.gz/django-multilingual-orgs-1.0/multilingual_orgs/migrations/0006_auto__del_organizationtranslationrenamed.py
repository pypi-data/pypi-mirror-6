...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'OrganizationTranslationRenamed'
        db.delete_table('multilingual_orgs_organizationtranslationrenamed')


    def backwards(self, orm):
        # Adding model 'OrganizationTranslationRenamed'
        db.create_table('multilingual_orgs_organizationtranslationrenamed', (
        ...
        db.send_create_signal('multilingual_orgs', ['OrganizationTranslationRenamed'])
