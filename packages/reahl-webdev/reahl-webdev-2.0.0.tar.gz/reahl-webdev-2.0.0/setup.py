...
setup(
    ...
    install_requires=[u'reahl-web>=2.0,<2.1', u'reahl-dev>=2.0,<2.1', u'reahl-component>=2.0,<2.1', u'reahl-tofu>=2.0,<2.1', u'pyOpenSSL>=0.13,<0.14', u'lxml>=2.3,<2.4', u'WebTest>=1.4,<1.5', u'selenium>=2.25,<2.27'],
    setup_requires=[],
