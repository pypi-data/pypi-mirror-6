...
(function() {
  ...
  window.Controls.dt = (function(_super) {
    ...
    dt.prototype.createDom = function() {
      var w;
      w = this._int_to_px(this.properties.width);
      return "<table cellspacing=\"0\" cellpadding=\"0\" class=\"control table " + (this.s(this.properties.style)) + " --child-container\" style=\"width: " + w + "\">\n    <tbody>\n        <children>\n    </tbody>\n</table>";
    };
  ...
  window.Controls.sortabledt = (function(_super) {
    ...
    sortabledt.prototype.detectUpdates = function() {
      ...
      this.newOrder = [];
      hasChanges = false;
      this.tbody.find('>*').each((function(_this) {
        return function(i, e) {
          var idx;
  ...
  window.Controls.dth = (function(_super) {
    ...
    dth.prototype.createDom = function() {
      var w;
      w = this._int_to_px(this.properties.width);
      return "<th style=\"width: " + w + "\">" + (this.s(this.properties.text)) + "</th>";
    };
  ...
  window.Controls.collapserow = (function(_super) {
    ...
    collapserow.prototype.setupDom = function(dom) {
      ...
      this.container = $(this.dom).find('>td>.children')[0];
      this.expanded = this.properties.expanded;
      if (!this.properties.expanded) {
        $(this.container).hide();
      }
      $(this.dom).find('>td>.header').append($(this.dom).find('>td>.children>*:first'));
      this.header = $(this.dom).find('>td>.header')[0];
  ...
  window.Controls.collapse = (function(_super) {
    ...
    collapse.prototype.setupDom = function(dom) {
      ...
      this.header.click((function(_this) {
        return function(e) {
          _this.expanded = !_this.expanded;
          _this.publish();
          _this.container.toggle('blind');
      ...
      return this.header.append($(this.dom).find('.children > *')[0]);
    };
