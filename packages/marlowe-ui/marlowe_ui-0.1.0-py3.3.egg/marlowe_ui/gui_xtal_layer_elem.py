...
class XtalLayerElem(tk.Frame):
    def __init__(self, master=None, *args, **kw):
        ...
        # axis A and B
        self.axisalabel = tk.Label(self, text='AXISA')
        self.axisa = tktool.validateentry.Vec3d(self)
        self.axisa.config(width=10)
        self.axisalabel.grid(row=prow, column=0, sticky=tk.E)
        self.axisa.grid(row=prow, column=1, sticky=tk.W)
        prow += 1

        self.axisblabel = tk.Label(self, text='AXISB')
        self.axisb = tktool.validateentry.Vec3d(self)
        self.axisb.config(width=10)
        self.axisblabel.grid(row=prow, column=0, sticky=tk.E)
        self.axisb.grid(row=prow, column=1, sticky=tk.W)
        prow += 1
    ...
    def set(self, d):
        ...
        self.axisa.set(d.get('axisa',
            defaultparam.xtal_layer_elem_default['axisa']))
        self.axisb.set(d.get('axisb',
            defaultparam.xtal_layer_elem_default['axisb']))
    ...
    def get(self):
        ...
        d['axisa'] = self.axisa.get()
        d['axisb'] = self.axisb.get()
    ...
    def enable(self):
        ...
        self.axisa.config(state=tk.NORMAL)
        self.axisb.config(state=tk.NORMAL)
        self.site.enable()
        if self.surfopt_enabled:
            self.surfopt.enable()
        else:
    ...
    def disable(self):
        ...
        self.axisa.config(state=tk.DISABLED)
        self.axisb.config(state=tk.DISABLED)
        self.site.disable()
        self.surfopt.disable()
        self.disabled = True
