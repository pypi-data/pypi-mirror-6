...
def publish_notes(args):
    import cnblogs
    cnblogs.publish_notes(args.all)
    return
...
def def_parser():
    ...
    parser_publish = subparsers.add_parser('p',
            help='Publish technical notes to blogs on www.cnblogs.com')
    parser_publish.add_argument('-a', '--all', action='store_true',
            help='Publish all technical notes to blogs (instead of new notes from last publish')
