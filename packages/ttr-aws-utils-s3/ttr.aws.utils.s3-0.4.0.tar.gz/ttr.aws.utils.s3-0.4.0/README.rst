...
5. Finally, you can try generating temorary url to your feed (showing latest of versions)::
    ...
    $ s3tmpgen mybucket my/versioned/feed.xml
    bucket_key_tmpurl:
      mybucket:
        my/versioned/feed.xml: https://mybucket.s3.amazonaws.com/my/versioned/feed.xml?Signature=o..A%3D&Expires=1342304229&AWSAccessKeyId=A....A
    expire: '2012-07-14T22:17:09Z'
...
::
  ...
  $ s3tmpgen -h
  usage: s3tmpgen [-h] [-profile-name None] [-aws-access-key-id None] [-aws-secret-access-key None] expire_dt bucket_name [key_names [key_names ...]]
