...
def get_env_type_db():
    ...
    admin_secret_field = fields.AutoGeneratedPasswordField(
        'admin-secret', label='admin secret', required=True,
    ...
    env_type_db['ec2'] = {
        'label': 'Amazon EC2',
        'description': (
            'The ec2 provider enable you to run Juju on the EC2 cloud. '
    ...
    env_type_db['openstack'] = {
        ...
        'description': (
            'The openstack provider enable you to run Juju on OpenStack '
    ...
    env_type_db['azure'] = {
        'label': 'Windows Azure',
        'description': (
            'The azure provider enable you to run Juju on Windows Azure. '
...
def map_fields_to_env_data(env_metadata, env_data):
    ...
    # Start building a list of (field, value) pairs preserving fields order.
    field_value_pairs = [
