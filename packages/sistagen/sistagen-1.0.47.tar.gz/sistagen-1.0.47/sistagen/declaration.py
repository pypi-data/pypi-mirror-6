...
class Declaration:
    ...
    def use(self, decl):
        ...
        _update_nonnull(self.inputs, copy.deepcopy(decl.inputs))
        #self.output.update( copy.deepcopy(decl.output) )
        _update_nonnull(self.output, copy.deepcopy(decl.output))
        
        self.sizes += copy.deepcopy(decl.sizes)
        self.dates += copy.deepcopy(decl.dates)
        #self.options.update( copy.deepcopy(decl.options) )
        _update_nonnull(self.options, copy.deepcopy(decl.options))
