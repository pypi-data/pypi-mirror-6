...
def pcd(func,dnamsel,datin,datout,appenddim = False, maxmembytes = 10000000, 
    ...
    maxmembytes: The option is applicable when using appenddim. The maximum amount of bytes that is allowed for the buffers to be read/written from/to the input/output data streams. 
    order: specify the order of the output dimensions (optional)
    squeeze: squeeze the output variables: remove the dimensions of length unity for each of the output variables for having cleaner output
    """
