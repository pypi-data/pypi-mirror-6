...
from collective.portlet.mybookmarks.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, mybookmarksportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        # constructor.
        assignment = assignment or mybookmarksportlet.Assignment()
