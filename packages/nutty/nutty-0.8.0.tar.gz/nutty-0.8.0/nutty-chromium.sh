...
if [ $(uname -s) == Darwin ]; then
  EXT_DIR=$HOME"/Library/Application Support/Google/Chromium/Default/Extensions/ooelecakcjobkpmbdnflfneaalbhejmk/"
else
  EXT_DIR=$HOME"/.config/chromium/Default/Extensions/ooelecakcjobkpmbdnflfneaalbhejmk/"
fi
