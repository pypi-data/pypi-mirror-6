...
class Primary(object):
    ...
    def __init__(self, inputString, line, charPositionInLine):
        ...
        self.op_not = False
        self.op_minus = False
        # kind can be 'primaryId', 'enumeratedValue', 'numericalValue_int',
        # 'numericalValue_float',
...
class Task(object):
    ...
    def __init__(self):
        ...
        self.width = 70
        self.height = 35
        # one of 'informal_text', 'assign', 'for_loop'
        self.kind = None
        # list of 'assign'-kind Expression
        self.assign = []
        # list of strings
        self.informalText = []
        # list of for-loops:{'var': string, 'type': Asn1SccType,
