...
class Character(models.Model):
    name = models.CharFieldField(max_length=80, unique=True)
    firstname = models.CharFieldField(max_length=80,blank=True,null=True)
    lastname = models.CharFieldField(max_length=80,blank=True,null=True)
    book = models.ManyToManyField(Book, blank=True,null=True)
    bioshort = models.CharFieldField(max_length=500,blank=True,null=True)
...
class Nickname(models.Model):
    ...
    personality = models.NullBooleanFiel(default=None) # eg Grumpy, Crazy, Drunken, Brainy, Dopey
