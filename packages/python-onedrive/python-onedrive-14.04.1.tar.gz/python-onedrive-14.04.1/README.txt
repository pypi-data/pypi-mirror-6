...
Python and command-line interface for `OneDrive API (version
...
(`see #2 <https://github.com/mk-fg/python-onedrive/issues/2>`_).
...
"mobile" in `DevCenter <https://dev.live.com/>`_ for that to work.
