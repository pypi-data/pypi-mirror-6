...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelTaskMeta.state'
        db.add_column(u'djcelery_model_modeltaskmeta', 'state',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelTaskMeta.state'
        db.delete_column(u'djcelery_model_modeltaskmeta', 'state')
