...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('multilingual_orgs_organization_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['multilingual_orgs.Organization'])),
        ))
        db.send_create_signal('multilingual_orgs', ['OrganizationTranslation'])

        # Adding unique constraint on 'OrganizationTranslation', fields ['language_code', 'master']
        db.create_unique('multilingual_orgs_organization_translation', ['language_code', 'master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationTranslation', fields ['language_code', 'master']
        db.delete_unique('multilingual_orgs_organization_translation', ['language_code', 'master_id'])

        # Deleting model 'OrganizationTranslation'
        db.delete_table('multilingual_orgs_organization_translation')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'multilingual_orgs.organizationpersonrole': {
            'Meta': {'object_name': 'OrganizationPersonRole'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multilingual_orgs.Organization']"}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']"}),
            'position': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Role']", 'null': 'True', 'blank': 'True'})
        },
        'multilingual_orgs.organizationpluginmodel': {
            'Meta': {'object_name': 'OrganizationPluginModel', 'db_table': "'cmsplugin_organizationpluginmodel'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'display_type': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multilingual_orgs.Organization']"})
        },
        'multilingual_orgs.organizationtranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'OrganizationTranslation', 'db_table': "'multilingual_orgs_organization_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['multilingual_orgs.Organization']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '2000'})
        },
        'multilingual_orgs.organizationtranslationrenamed': {
            'Meta': {'object_name': 'OrganizationTranslationRenamed'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
