...
def A(event=None, arg=None):
    ...
    if _Installer is None:
        _Installer = Installer('installer', 'AT_STARTUP', 1)
    ...
    def A(self, event, arg):
        ...
        #---RECOVER---
            ...
            if event == 'print' :
                ...
                self.state = 'LOAD_KEY'
                self.doUpdate(arg)
            elif ( event == 'identity_restorer.state' and arg is 'DONE' ) or ( event == 'identity_restorer.state' is 'RESTORED!' and self.flagCmdLine ) :
                self.state = 'DONE'
                self.doUpdate(arg)
        #---DONE---
