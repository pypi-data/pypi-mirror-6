...
olarization rate, 3) phase shift between s- and p-components and 4) ratio of
axes of the polarization ellipse. Watch how the circular polarization rate
becomes close to 1 or -1 at certain departure anglesl; here, between 16 and 32
...
polarization plane (horizontal). Watch the circular polarization rate and
the ratio of axes of the polarization ellipse at :math:`\pm` 128 arcsec
departure angle.
