...
moderation options::
    ...
    from backtalk.moderation import CommentModerator, moderator
...
class CommentModerator(object):
    ...
    def email(self, comment, content_object, request):
        ...
        t = loader.get_template('backtalk/comment_notification_email.txt')
...
class Moderator(object):
    ...
    def connect(self):
        ...
        """
        signals.comment_will_be_posted.connect(self.pre_save_moderation, sender=backtalk.get_model())
        signals.comment_was_posted.connect(self.post_save_moderation, sender=backtalk.get_model())
