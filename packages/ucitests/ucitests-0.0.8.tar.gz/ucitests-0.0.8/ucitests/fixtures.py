...
def set_uniq_cwd(test):
    ...
    the 'addCleanup' method and will set the 'test_tmp_dir' attribute.
    ...
    temporary directory. This can also be used to create a home directory (as
    long as $HOME is also set appropriately) when the test needs to access '~/'
    files for example.
    """
