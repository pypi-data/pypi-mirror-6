...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rforum_forum', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rforum.Forum'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.parent'
        db.delete_column('rforum_forum', 'parent_id')
    ...
    models = {
        ...
        'rforum.forum': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rforum.Forum']", 'null': 'True', 'blank': 'True'}),
        ...
        'rforum.log': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'log'", 'to': "orm['auth.User']"}),
