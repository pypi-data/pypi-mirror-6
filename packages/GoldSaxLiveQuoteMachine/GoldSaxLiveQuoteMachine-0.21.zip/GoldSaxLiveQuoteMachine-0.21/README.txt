...
you can git clone from https://github.com/VanceKingSaxbeA/GoldSaxLiveQuoteMachine

by git clone https://github.com/VanceKingSaxbeA/GoldSaxLiveQuoteMachine.git

This is a dependancy Module to be used with GoldSaxEngine-******Markets. To Auto create tables based on source assets. 
pip install goldsaxLiveQuoteMachine before you can use it.
