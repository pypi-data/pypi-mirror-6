...
def test_VBRAINSDemonWarp_inputs():
    ...
    checkerboardPatternSubdivisions=dict(sep=',',
    argstr='--checkerboardPatternSubdivisions %s',
    ),
    seedForBOBF=dict(sep=',',
    ...
    arrayOfPyramidLevelIterations=dict(sep=',',
