...
There are a few commandline scripts as well, which are currently mainly useful
on Windows(tm) operating systems, where the interpreter is not in the PATH by
default:
