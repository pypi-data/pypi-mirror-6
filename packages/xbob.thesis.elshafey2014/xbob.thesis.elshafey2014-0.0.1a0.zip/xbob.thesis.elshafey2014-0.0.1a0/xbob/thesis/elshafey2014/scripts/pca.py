...
def command_line_arguments(command_line_parameters):
  ...
  parser.add_argument('-f', '--features', default = 'linearize', help = 'Feature extraction configuration.')
  # - the tool configuration
  parser.add_argument('-t', '--tool', default = 'default-pca', help = 'Face recognition tool (algorithm) configuration.')
  ...
  parser.add_argument('-b', '--sub-directory', metavar = 'DIR', default = 'pca', help = 'The sub-directory where the files of the current experiment should be stored. Please specify a directory name with a name describing your experiment.')
  # - the temp directory
...
def main(command_line_parameters = sys.argv):
  ...
  facereclib.utils.info("Executing algorithm 'PCA'")
