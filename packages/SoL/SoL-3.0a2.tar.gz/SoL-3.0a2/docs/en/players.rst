...
known with different names, his results cannot be correctly summarized in the season's
championship, where he appears more than once, with different *aliases*.
