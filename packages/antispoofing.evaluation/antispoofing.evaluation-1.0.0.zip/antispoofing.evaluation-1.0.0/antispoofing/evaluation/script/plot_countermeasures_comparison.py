  ...
  if args.demandedplot == 10:
    for antispoofingalg in ('LBP',):
      ...
      for antispoofingalg in ('LBP','LBP-TOP-1', 'MOTION','ALL'):
        ...
        if args.var_param == 'omega':
          omega, beta, thrs_cm = error_utils.epsc_thresholds(base_neg_dev_cm, base_pos_dev_cm, over_neg_dev_cm, over_pos_dev_cm, points=points, beta=args.beta, criteria=criteria)
        else:
          omega, beta, thrs_cm = error_utils.epsc_thresholds(base_neg_dev_cm, base_pos_dev_cm, over_neg_dev_cm, over_pos_dev_cm, points=points, omega=args.beta, criteria=criteria)
