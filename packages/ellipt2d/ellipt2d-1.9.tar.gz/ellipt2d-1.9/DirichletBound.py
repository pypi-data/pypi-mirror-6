#!/usr/bin/python
# $Id: DirichletBound.py,v 1.3 2003/07/16 13:50:10 pletzer Exp $
#
...
class DirichletBound:
    ...
    def setData(self,data):
        ...
        if type(data) == DictType:
            ...
            raise TypeError, self.__class__,'in setData(...)'
    ...
    def isBound(self,i):
        ...
        Returns 0 otherwise.
        """
        return (i in self.data.keys()) # returns 0 for no and 1 for yes.
	...
	tag = 0 (no node numbers), tag = 1 (node numbers)
        ...
        try:
            ...
            print """
            DirichletBound::plot Failed!
            Most probably, Tkinter could not be imported.
            """
