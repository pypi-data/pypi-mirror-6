...
TSGeom (Time Series Geometry) provides functions for identifying the peaks and
valleys of a time series. Additionally, it provides a function for computing
...
For fastest understanding, `view the IPython notebook demo tutorial <http://nbviewer.ipython.org/github/jbn/TSGeom/blob/master/tsgeom_demo.ipynb>`_.

Contributing
------------
This is an admittedly small project. Still, if you have any contributions, 
please `fork this project on github <https://github.com/jbn/PeakValley>`_ and 
