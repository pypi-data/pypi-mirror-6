      ...
      resizeSidebar = (function(_this) {
        return function() {
          ...
          return setTimeout(function() {
            ...
            console.log(h);
            $(_this.dom).find('>.sidebar>.tabs-container').css({
              height: h
            });
            return setTimeout(function() {
              $(_this.dom).find('>.sidebar>.tabs-container').jScrollPane();
              $(_this.dom).find('>.sidebar>.tabs-container').css({
                width: '150px'
              });
              return $(_this.dom).find('>.sidebar>.tabs-container .jspContainer').css({
                width: '150px',
                height: h
              });
            }, 1);
