...
class TestAptPackages(object):
 ...
 PostgreSQL is an object-relational SQL database management system.'''
    ...
    def test_adding(self, pgdg):
        ...
        assert pgdg.packages[('test', '1')]['Size'] == '0'
...
class TestAptRelease(object):
    ...
    def test_update_hash(self, pgdg):
        ...
        assert pgdg.hashes['md5']['main/binary-amd64/Packages'] == ('d41d8cd98f00b204e9800998ecf8427e', '0')
        assert pgdg.hashes['sha1']['main/binary-amd64/Packages'] == ('da39a3ee5e6b4b0d3255bfef95601890afd80709', '0')
        assert pgdg.hashes['sha256']['main/binary-amd64/Packages'] == ('e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855', '0')
...
class TestAptRepository(object):
    ...
    def repo(self, storage):
        return AptRepository(storage, None, None)

    def test_duplicate_upload(self, repo, package_path):
        assert repo.add_package(package_path)
        assert not repo.add_package(package_path)

    def test_duplicate_upload_force(self, repo, package_path):
        assert repo.add_package(package_path)
