...
##############################################################################
"""
$Id: application.py 3911 2013-12-27 13:58:25Z roger.ineichen $
"""
...
class WSGIApplication(object):
    ...
    def __call__(self, environ, start_response):
        ...
        handle_errors = environ.get('wsgi.handle_errors', self.handle_errors)

        # publish request and get response
        request = self.publisher.publish(request, handle_errors=handle_errors)
...
class PMDBWSGIApplication(WSGIApplication):
    ...
    def __call__(self, environ, start_response):
        environ['wsgi.handle_errors'] = False
...
def getWSGIApplication(configfile, schemafile=None, features=(),
    publisher=p01.publisher.publisher.Publisher, handle_errors=True):
    ...
    wsgi = WSGIApplication(app, publisher, handle_errors)
