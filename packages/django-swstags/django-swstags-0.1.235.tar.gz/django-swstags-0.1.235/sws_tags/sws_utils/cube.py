...
def requestCube(ip_connect,name_bbdd,name_cube,col_cube,med_cube,request_data,ifDate,dimension_filters,database_cube_dict,total_data = False,where_tupla=('Date','Id','Id'),request_date_previous = False,complete_name=False,format_cube=False,n_c=[],ip_memcache="127.0.0.1:112",time_zone=""):
    ...
    cube.connect(ip_connect,name_bbdd,n_c,ip_memcache)
    exclude_rows={}
    where={}
    data_order = ''
    part_order={}
...
def requestCubeHighcharts(ip_connect,name_bbdd,name_cube,col_cube,med_cube,request_data,ifDate,dimension_filters,database_cube_dict,total_data = True,where_tupla=('Date','Id','Id'),request_date_previous = False, format_cube=False,n_c=[],ip_memcache="127.0.0.1:112",time_zone=""):
...
def requestCubeFilters(ip_connect,name_bbdd,name_cube,col_cube,med_cube,request_data,ifDate,dimension_filters,database_cube_dict=False,where_tupla=('Date','Id','Id'),n_c=[],ip_memcache="127.0.0.1:112",time_zone=""):
