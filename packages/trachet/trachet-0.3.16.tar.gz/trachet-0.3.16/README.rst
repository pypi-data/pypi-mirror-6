...
- Run default shell and send formatted I/O sequence to a terminal device(/dev/ttys002)::

    $ trachet -o/dev/ttys002


- Run vim and send formatted I/O sequence to a terminal device(/dev/ttys002)::

    $ trachet -o/dev/ttys002 vim


- Run emacs and send formatted I/O sequence to a terminal device(/dev/ttys002), and "break" emacs on startup time::
