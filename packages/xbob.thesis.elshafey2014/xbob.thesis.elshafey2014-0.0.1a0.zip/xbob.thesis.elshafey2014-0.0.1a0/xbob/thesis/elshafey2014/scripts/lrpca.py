...
def command_line_arguments(command_line_parameters):
  ...
  parser.add_argument('-p', '--preprocessing', default = 'default-lrpca', help = 'Image preprocessing configuration.')
  # - the features configuration
  parser.add_argument('-f', '--features', default = 'default-lrpca', help = 'Feature extraction configuration.')
  # - the tool configuration
  parser.add_argument('-t', '--tool', default = 'default-lrpca', help = 'Face recognition tool (algorithm) configuration.')
  ...
  parser.add_argument('-b', '--sub-directory', metavar = 'DIR', default = 'lrpca', help = 'The sub-directory where the files of the current experiment should be stored. Please specify a directory name with a name describing your experiment.')
  # - the temp directory
...
def main(command_line_parameters = sys.argv):
  ...
  facereclib.utils.info("Executing algorithm 'LRPCA'")
