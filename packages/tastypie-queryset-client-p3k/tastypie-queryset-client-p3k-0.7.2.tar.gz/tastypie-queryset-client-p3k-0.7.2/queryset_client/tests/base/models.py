...
class Inbox(models.Model):
    ...
    def __unicode__(self):
        return smart_text("{0}".format(self.did))
...
class Message(models.Model):
    ...
    def __unicode__(self):
        return smart_text("{0}".format(self.subject))
...
class InboxMessage(models.Model):
    ...
    def __unicode__(self):
        return smart_text("{0} ({1})".format(self.inbox, self.message))
...
class Operation(models.Model):
    ...
    def __unicode__(self):
        return smart_text("name: {0}, opid: {1}".format(self.name, self.opid))
...
class Status(models.Model):
    ...
    def __unicode__(self):
        return smart_text("operation: {0}, contenttype: {1}, status: {2}".format(self.operation, self.contenttype, self.status))
...
class Strict(models.Model):
    ...
    def __unicode__(self):
        return smart_text("{0}".format(self.pk))
