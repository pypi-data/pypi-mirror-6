...
class GitLab(APIDefinition):
    ...
    class QualifiedListProjectsActionHelper(ExtraActionDefinition):
        method = _HTTP_GET
        ...
        def wrapper(cls, extra_action_fn, parent):
            def wrapped(*args, **kwargs):
                ...
                for arg in list(args):
                    print "arg:", arg
                import gitlab3 as gl3
                return gl3.list_fn(gl3.Project, parent, cls.url,
                                   addl_keys=args, **kwargs)
            return wrapped
    class FindProjectsByNameAction(QualifiedListProjectsActionHelper):
        """gl.find_projects_by_name(query)"""
        url = '/projects/search/:query'
    class AllProjectsAction(QualifiedListProjectsActionHelper):
        url = '/projects/all'
    class OwnedProjectsAction(QualifiedListProjectsActionHelper):
        url = '/projects/owned'
