...
def parse_args(command_line_parameters):
  ...
  config_group.add_argument('-p', '--preprocessing', metavar = 'x', nargs = '+', dest = 'preprocessor', default = ['default-tan-triggs'],
      help = 'Image preprocessing; registered preprocessors are: %s'%utils.resources.resource_keys('preprocessor'))
  config_group.add_argument('-f', '--features', metavar = 'x', nargs = '+', default = ['default-dct-blocks'],
      help = 'Feature extraction; registered feature extractors are: %s'%utils.resources.resource_keys('feature_extractor'))
  config_group.add_argument('-t', '--tool', metavar = 'x', nargs = '+', default = ['default-gmm'],
  ...
  other_group.add_argument('-K', '--kmeans-training-iterations', type=int, default=50,
  ...
  other_group.add_argument('-M', '--gmm-training-iterations', type=int, default=50,
  ...
  parser.add_argument('--sub-task',
      choices = ('preprocess', 'train-extractor', 'extract', 'normalize-features', 'kmeans-init', 'kmeans-e-step', 'kmeans-m-step', 'gmm-init', 'gmm-e-step', 'gmm-m-step', 'gmm-project', 'enroll', 'compute-scores', 'concatenate'),
