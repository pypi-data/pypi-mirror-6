...
Ext.define('MP.data.MetaData', {
    ...
    statics: {
        ...
        renderDate: Ext.util.Format.dateRenderer(_('m/d/Y')),

        renderTime: Ext.util.Format.dateRenderer(_('g:i A')),

        renderTimestamp: Ext.util.Format.dateRenderer(_('m/d/Y g:i:s A'))
    },
