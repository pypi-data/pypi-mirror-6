...
class JavaThriftLibrary(ExportableJvmLibrary):
  ...
  # TODO(John Sirois): extract knowledge and configuration of known compilers and their settings
  # from this target.  I should be able to add a new compiler without modifying this target.
