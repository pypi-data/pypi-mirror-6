...
class Data_site:  
    ...
    # -- Forcing file 
    fic_forc = '/your/working/directory/ORCHISM/inputs/forcing/DE-Bay1998.nc'
    
    # -- Configuration file
    fic_cfg = '/your/working/directory/ORCHISM/inputs/config/daily/DE-Bay.cfg'
    
    # -- Observation files 
    fic_obs = '/your/working/directory/ORCHISM/inputs/fluxes/DE-Bay_flux_1998.nc'
