...
# How does this fail when we're in console mode?
# Things are imported relative to __main__
# Perhaps we'll strip out __main__ if we see it returned by cloudpickle
...
class ModuleDependencyAnalyzer(object):
    ...
    _IMP_TYPE_NAMES = {
        ...
        imp.C_EXTENSION: 'c-extention',
        imp.C_BUILTIN: 'built-in',
    }

    def __init__(self):
        """Creates new ModuleDependencyAnalyzer"""
        self._logger = logging.getLogger('module-dependency-analyzer')
