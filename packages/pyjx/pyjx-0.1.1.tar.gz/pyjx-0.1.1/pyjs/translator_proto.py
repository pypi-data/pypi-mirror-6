...
class PlatformParser:
    ...
    def parseModule(self, module_name, file_name):
        ...
        if self.platform and os.path.isfile(platform_file_name):
            ...
            mod = merge(self.compiler.ast, module_name, mod, mod_override, {})
            override = True
...
class AppTranslator:
    ...
    def findFile(self, file_name):
        ...
        for library_dir in self.library_dirs:
            ...
            full_file_name = os.path.join(library_dir, file_name)
            ...
            full_file_name = os.path.join(library_dir, fnameinit)
            if os.path.isfile(full_file_name):
                return full_file_name
    ...
    def translate(self, module_name, is_app=True, debug=False,
        ...
        for library in library_modules:
            ...
            print >> lib_code, '\n//\n// BEGIN LIB '+library+'\n//\n'
            print >> lib_code, self._translate(library)
        ...
        if module_name:
            print >> app_code, self._translate(
                module_name, is_app, imported_js=imported_js)
