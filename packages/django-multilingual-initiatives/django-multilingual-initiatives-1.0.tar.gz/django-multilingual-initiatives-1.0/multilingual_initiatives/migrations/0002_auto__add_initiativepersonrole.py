...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InitiativePersonRole'
        db.create_table(u'multilingual_initiatives_initiativepersonrole', (
        ...
        db.send_create_signal(u'multilingual_initiatives', ['InitiativePersonRole'])


    def backwards(self, orm):
        # Deleting model 'InitiativePersonRole'
        db.delete_table(u'multilingual_initiatives_initiativepersonrole')
