...
from sc2reader.ext.standard.datapacks import *


@loggable
class StandardContextLoader(object):
    name = 'StandardContextLoader'

    def setup(self, engine):
        engine.register_datapack(wol16117.datapack,
                                 lambda r: r.expansion == 'WoL' and 16117 <= r.build < 17326)
        engine.register_datapack(wol17326.datapack,
                                 lambda r: r.expansion == 'WoL' and 17326 <= r.build < 18092)
        engine.register_datapack(wol18092.datapack,
                                 lambda r: r.expansion == 'WoL' and 18092 <= r.build < 19458)
        engine.register_datapack(wol19458.datapack,
                                 lambda r: r.expansion == 'WoL' and 19458 <= r.build < 22612)
        engine.register_datapack(wol22612.datapack,
                                 lambda r: r.expansion == 'WoL' and 22612 <= r.build < 24944)
        engine.register_datapack(wol24944.datapack,
                                 lambda r: r.expansion == 'WoL' and 24944 <= r.build)
        engine.register_datapack(hots_base.datapack,
                                 lambda r: r.expansion == 'HotS' and r.build < 23925)
        engine.register_datapack(hots23925.datapack,
                                 lambda r: r.expansion == 'HotS' and 23925 <= r.build < 24247)
        engine.register_datapack(hots24247.datapack,
                                 lambda r: r.expansion == 'HotS' and 24247 <= r.build <= 24764)
        engine.register_datapack(hots24764.datapack,
