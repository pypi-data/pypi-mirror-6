...
class DonationForm(forms.Form):
    MONTH_CHOICES = _generate_months()
    YEAR_CHOICES = _generate_years()
    ...
    exp_month = forms.ChoiceField(required=False, choices=MONTH_CHOICES)
    exp_year = forms.ChoiceField(required=False, choices=YEAR_CHOICES)
    cvc = forms.CharField(required=False)
    note = forms.CharField(widget=forms.Textarea())

    def __init__(self, *args, **kwargs):
        super(DonationForm, self).__init__(*args, **kwargs)
        self.fields['card_number'].widget.attrs['class'] = 'card-number'
        self.fields['exp_month'].widget.attrs['class'] = 'card-expiry-month'
        self.fields['exp_year'].widget.attrs['class'] = 'card-expiry-year'
        self.fields['cvc'].widget.attrs['class'] = 'card-cvc'
