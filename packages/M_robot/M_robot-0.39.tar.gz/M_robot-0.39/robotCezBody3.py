...
plt.show()
anim = animation.FuncAnimation(fig,vykresliRobota, frames=1000000,init_func=init, interval=5, blit=True)
show()
'''
ak je v zozname UhlovD ++ alebo -- za sebou, tak sa to dofrca
'''