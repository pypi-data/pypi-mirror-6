...
DEFAULT_CONFIG = {
    ...
    'schema_server_url': 'https://sdk-alpha.sbgenomics.com:1180',
    'file_server_url': 'sdk-alpha.sbgenomics.com',
    'vs_client_path': '/opt/vsclient/bin/vsclient.sh',

    'docker_registry_name': 'docker.sbgenomics.com:8888',
    'docker_registry_version': '1',
    'docker_registry_schema': 'http',
    'docker_daemon_url': 'unix://var/run/docker.sock',
    'docker_protocol_version': '1.6',
    'docker_user': 'wrapper',
    'docker_dns': None,
...
class Project(object):
    def __init__(self, context=None):
        context = context or {}
        self.sb_home = os.path.expanduser('~/.sb')
...
def destination(cwd, path):
    ...
    if os.path.isdir(dst) and os.listdir(dst):
        raise SbdkError("Can't initialize project in non-empty dir '%s'" % dst)
    return dst
