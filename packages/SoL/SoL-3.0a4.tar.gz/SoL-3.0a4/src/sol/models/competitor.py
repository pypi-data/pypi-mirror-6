...
class Competitor(Base):
    ...
    idcompetitor = Column(
        ...
        primary_key=True,
        nullable=False,
        info=dict(label=N_(u'Competitor ID'),
                  hint=N_(u'Unique ID of the competitor.')))
    """Primary key."""
    ...
    idtourney = Column(
        ...
        info=dict(label=N_(u'Tourney ID'),
                  hint=N_(u'ID of the tourney the competitor belongs to.')))
    ...
    idplayer1 = Column(
        ...
        info=dict(label=N_(u'Player ID'),
                  hint=N_(u'ID of the player.')))
    """First player's ID."""

    idplayer2 = Column(
        intid_t, ForeignKey('players.idplayer'),
        info=dict(label=N_(u'2nd player ID'),
                  hint=N_(u'ID of the second player.')))
    """Second player's ID."""

    idplayer3 = Column(
        intid_t, ForeignKey('players.idplayer'),
        info=dict(label=N_(u'3rd player ID'),
                  hint=N_(u'ID of the third player.')))
    """Third player's ID."""

    idplayer4 = Column(
        intid_t, ForeignKey('players.idplayer'),
        info=dict(label=N_(u'4th player ID'),
                  hint=N_(u'ID of the fourth player.')))
    """Fourth player's ID."""
    ...
    points = Column(
        ...
        nullable=False,
        default=0,
        info=dict(label=N_(u'Points'),
                  hint=N_(u'Points of the competitor.')))
    ...
    bucholz = Column(
        ...
        nullable=False,
        default=0,
        info=dict(label=N_(u'Bucholz'),
                  hint=N_(u'Weight of the opponents.')))
    ...
    netscore = Column(
        ...
        nullable=False,
        default=0,
        info=dict(label=N_(u'Net score'),
                  hint=N_(u'Net score of all games.')))
    ...
    totscore = Column(
        ...
        nullable=False,
        default=0,
        info=dict(label=N_(u'Total score'),
                  hint=N_(u'Total score of all games.')))
    ...
    prize = Column(
        ...
        nullable=False,
        default=0.0,
        info=dict(label=N_(u'Final prize'),
                  hint=N_(u'Final prize assigned at end of tourney.')))
    """Final prize."""
    ...
    retired = Column(
        ...
        nullable=False,
        default=False,
        info=dict(label=N_(u'Retired'),
                  hint=N_(u'Whether this competitor will play'
                          u' further matches.')))
    ...
    def caption(self, html=None):
        ...
        if not self.idplayer1:
            return _(u'Player NOT assigned yet!')
        else:
            captions = [self.player1.caption(html)]
            if self.idplayer2:
                captions.append(self.player2.caption(html))
            if self.idplayer3:
                captions.append(self.player3.caption(html))
            if self.idplayer4:
                captions.append(self.player4.caption(html))
            return njoin(captions)
