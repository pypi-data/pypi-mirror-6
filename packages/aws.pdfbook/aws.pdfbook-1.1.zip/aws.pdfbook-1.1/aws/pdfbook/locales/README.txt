...
Easy::
  ...
  $ cd .../aws.pdfbook/edf/sitestat/locales # Here ;)
  $ mkdir -p xx/LC_MESSAGES
  $ cp aws.pdfbook.pot xx/LC_MESSAGES/aws.pdfbook.po
  $ $EDITOR xx/LC_MESSAGES/aws.pdfbook.po
...
got aws.pdfbook with a subversion checkout.
