...
class HdfsLoad(object):
    ...
    def __init__(self, config):
        ...
        for f_in in self.f_list:
            ...
            try:
                ...
                #self.move_table(f_in_path, f_out_path)
    ...
    def get_table_name(self, f_name):
        return self.table_prefix + os.path.basename(os.path.splitext(f_name)[0])
    ...
    def move_table(self, in_file, out_file):
        print self.dest + os.path.basename(in_file)
        self.ssh_client.put(out_file,self.dest + os.path.basename(in_file))
    ...
    def load_data(self):
        ...
        for in_file in self.f_list:
            cur_unix_path = self.dest+"/"+in_file
