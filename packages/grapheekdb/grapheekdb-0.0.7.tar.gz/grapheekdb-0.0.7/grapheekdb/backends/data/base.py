...
class BaseGraph(GraphReadWrite):
    ...
    def __getattribute__(self, attr):
        try:
            ...
            pass  # no _closed attribute -> no definitely not closed (not even open, in fact)
    ...
    def _bulk_add_node(self, node_defns, silent=False):
        ...
        try:
            ...
            range_ids = range(first_node_id, last_node_id + 1)
    ...
    def _bulk_add_edge(self, edge_defns, silent=False):
        ...
        try:
            ...
            range_ids = range(first_edge_id, last_edge_id + 1)
