...
from writing_style.similarity import compare_texts
...
def similarity_to_twain(text):
    return compare_texts(text, open('writing_style/mark_twain.txt', 'r').read())
...
def analyze(text):
    return {
        ...
        'punctuation_ratios': punctuation_ratios(text),
        'twain': similarity_to_twain(text),
    }
