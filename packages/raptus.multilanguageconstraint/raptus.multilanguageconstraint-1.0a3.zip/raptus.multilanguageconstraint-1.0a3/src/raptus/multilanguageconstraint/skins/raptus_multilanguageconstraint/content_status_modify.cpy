...
##parameters=workflow_action=None, comment='', effective_date=None, expiration_date=None, language_action=None, languages=None, *args
...
if languages and language_action in ('remove', 'add'):
    view = new_context.restrictedTraverse('@@multilanguageconstraint')
    getattr(view, language_action)(languages)
