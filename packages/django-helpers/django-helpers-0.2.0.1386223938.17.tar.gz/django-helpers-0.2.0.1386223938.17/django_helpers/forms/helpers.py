...
from django_helpers.apps.forms.widgets import DateInput
from django_helpers.apps.autocomplete import fields
from django_helpers.apps.autocomplete.widgets import AutoCompleteWidget, SimpleAutoCompleteWidget
...
def DateField(label=None, date_format=None, max_date=None,
