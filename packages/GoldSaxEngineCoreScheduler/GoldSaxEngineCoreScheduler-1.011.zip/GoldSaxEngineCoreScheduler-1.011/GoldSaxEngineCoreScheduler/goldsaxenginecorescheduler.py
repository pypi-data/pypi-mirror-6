...
from GoldSaxCreateTablesYFinance import goldsaxcreatetablesyfinance
from time import localtime, strftime
from GoldSaxEngineInitialize import goldsaxengineinitialize

def start(location,databasestore):
        ...
        for listo in actionlist:
                ...
                elif lis[1] =='y' and lis[2].replace('"','')==databasestore+".db":
               
                        goldsaxcreatetablesyfinance.createtables(synamelist,lis[0].replace('"',''), database+lis[2].replace('"',''))
                ...
                with a_lock:
                        ...
                        for lines in fileaslist:
                                ...
                                if (close > rightnow > mktime[0]):
                                        ...
                                        thr.append(thread.start_newthread(goldsaxlivequotemachine.actionking, (lisj[1],b_lock, start1, lisj[0].replace('"',''),database+lisj[2].replace('"',''),0,synamelist,1,0,timetorun,jala) ))
