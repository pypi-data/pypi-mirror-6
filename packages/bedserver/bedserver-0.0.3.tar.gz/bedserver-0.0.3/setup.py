...
setup(
    name = "bedserver",
    version = "0.0.3", # Update also in __init__ ; look into zest.releaser to avoid having two versions
    ...
    package_dir={'bedserver': 'bedserver'},
    ...
    dependency_links = [],
    install_requires = ['pysam', 'tornado'],
)
