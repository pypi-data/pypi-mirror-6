...
#
# Created: Sun Dec  8 19:40:51 2013
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Calendars", None))
        self.calendarBox.setToolTip(_translate("Dialog", "Click here or press Ctrl-E to export the selected calendars.", None))
        self.calendarBox.setTitle(_translate("Dialog", "Limit display to selected calendars", None))
