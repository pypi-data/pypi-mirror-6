...
def discover(root_path=None, sources=None):
    ...
    if sources is None:
        ...
        sources = [
            ...
            'patterns': [
                '(?P<state_abbr>[A-Z]{2})_(?P<repository>[A-Z]+)_(?P<year>[0-9]{4})_(?P<variety>[A-Z]+)\.(?P<file_extension>asc)',
                ]
            },
            {
            'name': 'HCUP',
            ...
            'patterns': [
                '(?P<state_abbr>[A-Z]{2})_(?P<repository>[A-Z]+)_(?P<year>[0-9]{4})_(?P<variety>[A-Z]+)\.(?P<file_extension>exe|zip)',
                ]
            },
            {
            'name': 'HCUP',
            ...
            'patterns': [
                '(?P<state_abbr>[A-Z]{2})_(?P<repository>[A-Z]+)_(?P<year>[0-9]{4})_(?P<variety>[A-Z]+)\.(?P<file_extension>sas)',
                ],
            },
            {
            'name': 'PUDF',
            ...
            'content': 'load_uncompressed', #this can be omitted, or be whatever you want. It's in by default because the author uses it elsewhere in his work.
            'patterns': [
                '(?P<state_abbr>tx)_(?P<repository>pudf)_(?P<year>[0-9]{4})_(?P<variety>base|charges|facility)_definition\.(?P<file_extension>txt)',
                ],
            },
            ]
