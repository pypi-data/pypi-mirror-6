...
# rfl = client.get_reusable_form_list()
# create_team = False
# if len(rfl) > 0:
#     team = client.get_team_info()
#     if isinstance(team, Team) is False:
#         team = client.create_team("Team Name")
#         create_team = True
#     try:
#         client.add_team_member("demo_user@example.com")
#     except Forbidden:
#         pass
#     print [account["email_address"] for account in team.accounts]
#     if "demo_user@example" in [account["email_address"] for account in team.accounts]:
#         print 'aaaa'
#     # pdb.set_trace()
#     client.get_reusable_form(rfl[0].reusable_form_id)
#     client.add_user_to_reusable_form(
#         rfl[0].reusable_form_id, None, "demo_user@example.com")
#     client.remove_user_from_reusable_form(
#         rfl[0].reusable_form_id, None, "demo_user@example.com")
#     client.remove_team_member("demo_user@example.com")
