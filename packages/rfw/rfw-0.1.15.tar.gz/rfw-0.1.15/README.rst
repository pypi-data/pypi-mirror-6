...
See `rfwgen README`_ for more details.

.. _rfwgen README: config/deploy/README.rst
...
Copyrite (c) 2014 `SecurityKISS Ltd`_,
released under the `MIT License`_

.. _SecurityKISS Ltd: http://www.securitykiss.com
