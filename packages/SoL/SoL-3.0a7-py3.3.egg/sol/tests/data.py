...
class ClubData(metaclass=Fixture):
    class scr:
        description = u'Scarambol Club Rovereto'
        couplings = 'dazed'

    class fic:
        description = u'Federazione Italiana Carrom'
        couplings = 'dazed'
        isfederation = True

    class ccm:
        description = u'Carrom Club Milano'
        couplings = 'serial'
...
class ChampionshipData(metaclass=Fixture):
    class current:
        description = u'Current championship'
        club = ClubData.scr
        closed = True

    class next:
        description = u'Next championship'
        club = ClubData.ccm
        closed = False

    class scr2010:
        description = u'SCR 2010 (test)'
        club = ClubData.scr
        closed = False

    class skipworstprize:
        description = u'Skip worst prize'
        club = ClubData.scr
        skipworstprizes = 1
        closed = False

    class simpletourneys:
        description = u'Simple tourneys, no prizes'
        club = ClubData.scr
        prizes = 'none'
        couplings = 'dazed'

    class double:
        description = u'Double events'
        club = ClubData.scr
        playersperteam = 2
        closed = False
...
class RatingData(metaclass=Fixture):
    class european:
        description = u'European rating'
        level = 'A'

    class national:
        description = u'National rating'
        level = 'B'
...
class TourneyData(metaclass=Fixture):
    class first:
        ...
        date = TODAY
        description = u'First test tournment'
        currentturn = 3

    class second:
        championship = ChampionshipData.current
        date = TODAY+ONEDAY
        description = u'Second test tournment'

    class third:
        championship = ChampionshipData.next
        date = TODAY
        description = u'Another tourney'
        currentturn = 1

    class odd:
        championship = ChampionshipData.next
        date = TODAY+ONEDAY*2
        description = u'Odd tourney'

    class dazedodd:
        championship = ChampionshipData.current
        date = TODAY+ONEDAY*5
        description = u'Dazed odd tourney'
        couplings = 'dazed'

    class merge1:
        championship = ChampionshipData.current
        date = TODAY+ONEDAY*2
        description = u'Merging test tournment'
    ...
    class rated:
        championship = ChampionshipData.current
        date = TODAY+ONEDAY*4
        description = u'Rated test tournment'
        rating = RatingData.national
        currentturn = 3
    ...
    class rated_no_turns:
        championship = ChampionshipData.current
        date = TODAY-ONEDAY
        description = u'Rated empty tournment'
        rating = RatingData.european

    class skipworstprize_first:
        championship = ChampionshipData.skipworstprize
        date = TODAY-ONEDAY
        description = u'Skip worst prize first tourney'
        rankedturn = 0
        currentturn = 1
    ...
    class simple:
        ...
        date = date(2001, 1, 1)
        description = u'VerySimpleTourney'

    class double:
        championship = ChampionshipData.double
        date = TODAY
        description = u'Double event'
