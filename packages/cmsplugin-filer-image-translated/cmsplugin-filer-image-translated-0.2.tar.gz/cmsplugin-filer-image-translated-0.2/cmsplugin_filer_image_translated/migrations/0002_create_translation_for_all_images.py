...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for image in orm['filer.Image'].objects.all():
            if image.imagetranslation_set.all().count() == 0:
                orm['cmsplugin_filer_image_translated.ImageTranslation'].objects.create(
                    trans_name=image.name, image=image, language='en')
