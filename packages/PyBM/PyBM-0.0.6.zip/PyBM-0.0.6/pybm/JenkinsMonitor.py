                ...
                if 'url' in job_details['lastBuild']:
                    ...
                    try:
                        ...
                        try:
                            ...
                            raise UnknownProgressException('could not parse build details from {0}'.format(r.text))
...
#            print r.text
            ...
            for job in view['jobs']:
                if job['color'].endswith('anime'):
                    try:
                        temp_job_list.append(Job(job['name'], Status.BUILDING, self.get_job_progress(job)))
