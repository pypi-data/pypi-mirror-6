...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pages'
        db.create_table('rflatpages_pages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='page_from', to=orm['auth.User'])),
        ...
        db.send_create_signal('rflatpages', ['Pages'])


    def backwards(self, orm):
        # Deleting model 'Pages'
        db.delete_table('rflatpages_pages')
    ...
    models = {
        ...
        'rflatpages.pages': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'page_from'", 'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['rflatpages']