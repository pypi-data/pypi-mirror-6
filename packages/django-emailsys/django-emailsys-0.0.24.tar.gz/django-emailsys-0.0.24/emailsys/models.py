...
class SmsLog(models.Model):
    message_id = models.CharField(_('Message Id'), max_length=10)
    to_number = models.EmailField(_('To Number'), max_length=254)
    time = models.DateTimeField(_('Sent At'), auto_now_add=True)
    content = models.TextField(_('Content'),null=False)
    response = models.TextField(_('Response'),max_length=50,null=True)
    error = models.SmallIntegerField(_('Error'),default=0)
...
'''
Message and SmsCampaign object (not models)
'''
