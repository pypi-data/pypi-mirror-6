...
def vykresliRobota(i):
    ...
    dx1Rot,dy1Rot,dx2Rot,dy2Rot,dxLkRot,dyLkRot,dxPkRot,dyPkRot = robot.rotateRobot2(uhol = fun.kvant_angle_error(0.017),chyba=True,okoloStredu=True)
...
fig, ax = plt.subplots()
robot = rob.RobotSChybou(opacity=1,f1=0,f2=0.0)
line, = ax.plot([], [], lw=2)
