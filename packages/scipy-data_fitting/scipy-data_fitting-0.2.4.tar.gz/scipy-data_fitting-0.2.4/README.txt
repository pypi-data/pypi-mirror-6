...
.. |PyPI Version| image:: http://img.shields.io/pypi/v/scipy-data_fitting.svg
   :target: https://pypi.python.org/pypi/scipy-data_fitting
.. |MIT License| image:: http://img.shields.io/badge/license-MIT-red.svg
   :target: ./LICENSE.txt
.. |Coverage Status| image:: http://img.shields.io/coveralls/razor-x/scipy-data_fitting.svg
   :target: https://coveralls.io/r/razor-x/scipy-data_fitting
.. |Build Status| image:: http://img.shields.io/travis/razor-x/scipy-data_fitting.svg
