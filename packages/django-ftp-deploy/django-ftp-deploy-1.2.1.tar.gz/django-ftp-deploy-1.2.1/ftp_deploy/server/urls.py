...
urlpatterns = patterns('',
                       ...
                       url(r'^notification/$', NotificationView.as_view(), name='ftpdeploy_notification'),
                       url(r'^notification/add$', NotificationAddView.as_view(), name='ftpdeploy_notification_add'),
                       url(r'^notification/(?P<pk>\d+)/edit$', NotificationEditView.as_view(), name='ftpdeploy_notification_edit'),
                       url(r'^notification/(?P<pk>\d+)/delete$', NotificationDeleteView.as_view(), name='ftpdeploy_notification_delete'),
                       )
