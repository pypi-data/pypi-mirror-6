...
class Character(models.Model):
    ...
    bioshort = models.RichTextField(max_length=500,blank=True,null=True)
    biolong = models.RichTextField(blank=True,null=True)
    excerpts = models.RichTextField(blank=True,null=True)
