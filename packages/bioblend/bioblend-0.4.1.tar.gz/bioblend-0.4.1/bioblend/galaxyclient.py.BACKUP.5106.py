    ...
    def make_post_request(self, url, payload, params=None, files_attached=False):
        ...
        if files_attached:
            ...
            if r.status_code == 200:
                return r.json()
            raise ConnectionError("Unexpected response from galaxy: %s" %r.status_code, body=r.text) # @see self.body for HTTP response body
...
=======
        r = requests.put(url,data=payload,params=params)
        return r
>>>>>>> 06df7f58a27203b989c23051f5068e808715c31c
