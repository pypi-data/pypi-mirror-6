...
class JinjaStaticRenderer():
    ...
    def render_item(self, last_build_time, env, force_render, templates_dir, default_template, page):
        ...
        print "Last built at: %s, page mtime: %s, templ mtime: %s, ref-templates mtime: %s" % (last_build_time, page.get_modified_time(), template_modified_time, ref_template_mtime)
