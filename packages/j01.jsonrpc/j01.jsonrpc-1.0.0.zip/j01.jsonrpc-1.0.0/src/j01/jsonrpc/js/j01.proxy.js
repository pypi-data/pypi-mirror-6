 ...
 * @version Draft
 *
 * changes compared with z3c.xmlhttp, z3c.jsonrpcproxy:
...
JSONRPC.prototype.addMethod = function(name, callback, requestId, onError) {
    if (typeof(requestId) == 'undefined') {
        requestId = "jsonRequest";
    }
    var self = this;
    if(!self[name]){
        var method = new JSONRPCMethod(self, this._url, name, callback, requestId, this._version, onError);
        self[name] = method;
    }
}
...
function JSONRPCMethod(proxy, url, methodName, callback, requestId, version, handleErrors) {
