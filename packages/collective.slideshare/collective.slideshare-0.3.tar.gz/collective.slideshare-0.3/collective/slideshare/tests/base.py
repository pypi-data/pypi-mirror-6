...
def setup_product():
    ...
    import collective.slideshare
    zcml.load_config('configure.zcml', collective.slideshare)
    ...
    ztc.installPackage('collective.slideshare')
...
setup_product()
ptc.setupPloneSite(products=['collective.slideshare'])
