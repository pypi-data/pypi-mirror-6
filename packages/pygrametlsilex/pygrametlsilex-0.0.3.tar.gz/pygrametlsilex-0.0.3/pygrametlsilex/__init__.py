...
class ConnectionWrapper(object):
    """Provide a uniform representation of different database connection types.
       ...
       pygrametlsilex's code uses the 'pyformat' but the ConnectionWrapper performs
       ...
       pygrametlsilex's code which is the important thing here; we're not trying to
...
class BackgroundConnectionWrapper(object):
    """An alternative implementation of the ConnectionWrapper for experiments.
       ...
       ConnectionWrapper (see pygrametlsilex.parallel).
