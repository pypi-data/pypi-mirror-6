...
setup(
    ...
    install_requires=[u'reahl-interfaces>=2.0.0a3,<2.1', u'reahl-sqlalchemysupport>=2.0.0a3,<2.1', u'reahl-web>=2.0.0a3,<2.1', u'reahl-component>=2.0.0a3,<2.1', u'reahl-domain>=2.0.0a3,<2.1'],
    setup_requires=[],
    tests_require=[u'reahl-tofu>=2.0.0a3,<2.1', u'reahl-stubble>=2.0.0a3,<2.1', u'reahl-dev>=2.0.0a3,<2.1', u'reahl-webdev>=2.0.0a3,<2.1'],
