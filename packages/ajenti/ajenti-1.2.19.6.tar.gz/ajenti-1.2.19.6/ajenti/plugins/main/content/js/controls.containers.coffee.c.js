...
(function() {
  ...
  window.Controls.vc = (function(_super) {
    ...
    vc.prototype.createDom = function() {
      return "<div class=\"control container vc " + (this.s(this.properties.style)) + "\">\n    <children>\n</div>";
    };
  ...
  window.Controls.dt = (function(_super) {
    ...
    dt.prototype.createDom = function() {
      var w;
      w = this._int_to_px(this.properties.width);
      return "<table cellspacing=\"0\" cellpadding=\"0\"\n    class=\"control table " + (this.s(this.properties.style)) + " " + (!!this.properties.addrow ? 'has-addrow' : '') + " " + (this.childCount === 0 ? 'empty' : '') + "\"\n    style=\"width: " + w + "\">\n    <tbody>\n        <children>\n        <tr class=\"emptyrow\">\n            <td colspan=\"999\">\n                " + this.properties.emptytext + "\n            </td>\n        </tr>\n        <tr class=\"addrow\">\n            <td colspan=\"999\">\n                <a>\n                    <i class=\"icon-plus\"></i> " + this.properties.addrow + "\n                </a>\n            </td>\n        </tr>\n    </tbody>\n</table>";
    };

    dt.prototype.setupDom = function(dom) {
      dt.__super__.setupDom.call(this, dom);
      return $(this.dom).find('>tbody>tr.addrow>td>a').click((function(_this) {
        return function() {
  ...
  window.Controls.dtr = (function(_super) {
    ...
    dtr.prototype.createDom = function() {
      return "<tr class=\"row\"><children></tr>";
    };
