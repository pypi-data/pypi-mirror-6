...
def register_config():
  ...
  if not Config.has_section('way2sms'):
    op1 = raw_input(">>> Do you have way2sms Account ?(y/n):")
    if op1 and op1[0]=='y':
      username = raw_input(">>> Enter UserName:")
      password = raw_input(">>> Enter Password:")
  ...
  with os.fdopen(os.open(CONFIG_FILE_LOC, os.O_WRONLY | os.O_CREAT, 0777), 'wb') as configfile:
...
def main():
    ...
    if options.number and options.text:
       ...
       print "1. sms 8147830733 Hi I am Dipankar"
       print "2. sms -s 160by2 8147830733 Hi! Dipankar again !"
       print "3. sms -s way2sms -m 8147830733 -t Yes ! Dipankar Again!!"
