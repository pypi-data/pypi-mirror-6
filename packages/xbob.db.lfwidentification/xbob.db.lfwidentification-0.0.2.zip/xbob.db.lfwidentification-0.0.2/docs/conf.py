...
project = u'LFW Identification Database (Bob API)'
import time
...
from xbob.db.lfwidentification.driver import Interface
...
man_pages = [
    ('index', 'bob', u'LFW Identification Database (Bob API) Documentation', [u'Idiap Research Institute'], 1)
]
