...
Date:         2013.9.7
Description:  This program creates a MySQL database containing mouse colony 
              information.  It also contains a web server which, when 
              launched, allows users to retrieve and update information on 
              the database. 


INSTALLATION FOR WINDOWS
========================
1. Install MySQL (for windows: http://dev.mysql.com/downloads/windows/installer/)
...
BUGS
====
* If viewing on the chrome web browser which has the google docs app 
