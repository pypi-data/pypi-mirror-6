...
project = u'Experiments of Laurent El Shafey\'s thesis'
import time
...
man_pages = [
    ('index', 'xbob.thesis.elshafey2014', u'Experiments of Laurent El Shafey\'s thesis Documentation', [u'Idiap Research Institute'], 1)
]
