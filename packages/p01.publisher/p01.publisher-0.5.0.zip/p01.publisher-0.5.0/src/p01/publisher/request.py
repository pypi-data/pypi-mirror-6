...
$Id: request.py 3926 2014-01-14 23:17:56Z roger.ineichen $
"""
...
from zope.publisher.browser import DEFAULTABLE_METHODS
...
from zope.publisher.http import LenientCookie
...
# XXX: do we need to parse body for HEAD requests? I guess not
    def processInputs(self):
        """See IPublisherRequest"""
        fp = None
        if self.method != 'GET':
