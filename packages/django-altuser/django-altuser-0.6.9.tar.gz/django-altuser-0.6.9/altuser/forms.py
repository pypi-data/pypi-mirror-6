...
class FollowUserWithpasswordForm(FollowUserForm):
    """
    ...
    def __init__(self, check_password=True, *args, **kwargs):
        super(FollowUserWithpasswordForm, self).__init__(*args, **kwargs)
    ...
    def clean(self):
        cleaned_data = super(FollowUserWithpasswordForm, self).clean()
        try:
