...
class Connection(object):
    ...
    def search(self, query='', date_start=None, date_finish=None, fields=None, size=0, query_size=10): #size => points_limit, query_size => series_limit ? and change in API?
        """
    ...
    def scroll(self, query='', date_start=None, date_finish=None, fields=None, size=0): #size => points_limit and change in API?
        """
