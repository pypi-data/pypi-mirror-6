...
def request(method, endpoint_format, payload, extension='.json', payload_prep_func=json.dumps):
    ...
    if 'reference_id' in payload.keys():
        endpoint = endpoint_format.format(reference_id=params["reference_id"])
