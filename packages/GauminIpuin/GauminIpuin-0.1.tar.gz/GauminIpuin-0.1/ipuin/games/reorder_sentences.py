from . import Game, GameConfig, register_game
...
class ReorderSentencesConfig(GameConfig):
    ...
    description = "Ordenatu esaldi hauek"
...
class ReorderSentences(Game):
    ...
    def build(self):
        container = ReorderSentencesWidget()

        self.orientation = self.spec.get('orientation', 'vertical')
...
register_game('ReorderSentences', ReorderSentences)
