...
class Data_site:  
    ...
    # -- Forcing file 
    fic_forc = '/your/working/directory/ORCHISM/inputs/forcing/SE-Nor1996-1997.nc'
    
    # -- Configuration file
    fic_cfg = '/your/working/directory/ORCHISM/inputs/config/daily/SE-Nor.cfg'
    
    # -- Observation files 
    fic_obs = '/your/working/directory/ORCHISM/inputs/fluxes/SE-Nor_flux_1996-1997.nc'
