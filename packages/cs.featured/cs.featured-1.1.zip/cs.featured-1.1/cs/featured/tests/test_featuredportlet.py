...
from cs.featured.portlets import featuredportlet
from cs.featured.portlets.tests.base_featuredportlet import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='cs.featured.portlets.featuredportlet')
        self.assertEquals(portlet.addview, 'cs.featured.portlets.featuredportlet')
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = featuredportlet.Assignment()
...
class TestRenderer(TestCase):
    ...
    def renderer(self, context=None, request=None, view=None, manager=None, assignment=None):
        ...
        assignment = assignment or featuredportlet.Assignment()
        return getMultiAdapter((context, request, view, manager, assignment), IPortletRenderer)

    def test_render(self):
        # TODO: Pass any keywoard arguments to the Assignment constructor
        r = self.renderer(context=self.portal, assignment=featuredportlet.Assignment())
