...
class WorkflowManager(object):
    ...
    def registerWorkflow(self, workflow_config):
            workflow_object = utils.get_class(workflow_config['class_name'])
            workflow_object.config = workflow_config
            workflow_object.abort()
    ...
    def findFolderWorkflow(self, path):
        ...
        for name in self.workflows:
            ...
            wf_folder_bits = self.workflows[name].config['folder'].split('/')
