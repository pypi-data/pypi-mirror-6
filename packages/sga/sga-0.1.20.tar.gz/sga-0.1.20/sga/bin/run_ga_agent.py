...
sys.path.insert(0, '../../')
import sga
from sga.ga_agent import GAAgent
...
def build_parser():
    ...
    parser.add_argument('-t', '--host', default=constants.GA_AGENT_DEFAULT_HOST, help='bind host', action='store')
    parser.add_argument('-p', '--port', default=constants.GA_AGENT_DEFAULT_PORT, type=int, help='bind port', action='store')
