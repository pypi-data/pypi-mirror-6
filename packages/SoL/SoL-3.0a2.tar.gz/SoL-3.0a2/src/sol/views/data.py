...
@expose(select([_clubs_t,
    ...
    Championships=dict(label=_(u'Championships'),
                 hint=_(u'Number of championships organized by the club.'),
                 width=40,
                 readonly=True,
                 sortable=False)
    ))
...
_players_metadata = dict(
    ...
    nickname=dict(nullable=True),
    password=dict(hidden=True,
                  password=True,
                  width=40,
                  nullable=True),
    sex=dict(hidden=True, width=80),
    nationality=dict(hidden=True, width=120),
    ...
    Club=dict(label=_clubs_t.c.description.info['label'],
              hint=_(u'The club this player is affiliated with.'),
              flex=1,
              nullable=True,
    ...
    Federation=dict(label=_('Federation'),
                    hint=_(u'The federation this player is associated with.'),
                    hidden=True,
                    nullable=True,
                    lookup=dict(url='/data/federations?sort=description',
                                ...
                                innerTpl=('<div class="sol-flags-icon sol-flag-{nationality}"'
                                          ...
                                          '">{description}'
                                          '</div>'))),
    CountPlayed=dict(label=_(u'Tourneys'),
                     hint=_(u'Number of played tourneys.'),
                     hidden=True,
                     readonly=True),
    FirstPlayed=dict(label=_(u'First tourney'),
                     hint=_(u'Oldest partecipation.'),
                     hidden=True,
                     readonly=True),
    LastPlayed=dict(label=_(u'Last tourney'),
                    hint=_(u'Most recent partecipation.'),
                    hidden=True,
                    readonly=True),
    )
...
def players(request, results):
    ...
    if 'metadata' in results:
        ...
        results['metadata']['fields'].append({
            'label': t(_(u'Language')),
            'hint': t(_(u'The preferred language of the player, used'
                        u' to send email messages and for the user interface'
                        u' when he logs in.')),
            'name': 'Language',
            'hidden': True,
            'nullable': True,
...
@expose(select([_championships_t, _clubs_t.c.description.label('Club'),
    ...
    Club=dict(label=_clubs_t.c.description.info['label'],
              hint=_(u'Club that organize the tourneys of the championship.'),
              flex=1,
              lookup=dict(url=('/data/clubs?only_cols=idclub,description,nationality'
                               '&sort=nationality,description'),
                          idField='idclub',
                          ...
                          innerTpl=('<div class="sol-flags-icon sol-flag-{nationality}"'
                                    ...
                                    '">{description}'
                                    '</div>'))),
    Previous=dict(label=_(u'Previous championship'),
                  hint=_(u'Previous championship, used by weighted prize-giving method.'),
                  hidden=True,
                  nullable=True,
                  lookup=dict(url='/data/championships?only_cols=idchampionship,description&sort=description&filter_closed=true',
                              ...
                              displayField='description')),
    Tourneys=dict(label=_(u'Tourneys'),
                  hint=_(u'Number of tourneys in the championship.'),
                  width=40,
                  readonly=True,
                  sortable=False)
    ))
...
@expose(select([_tourneys_t,
    ...
    Championship=dict(label=_championships_t.c.description.info['label'],
                      hint=_(u'Championship this tourney belongs to.'),
                      flex=1,
    ...
    Rating=dict(label=_ratings_t.c.description.info['label'],
                      hint=_(u'The rating this tourney will use and update, if any.'),
                      hidden=True,
                      nullable=True,
    ...
    PlayersPerTeam=dict(label=_championships_t.c.playersperteam.info['label'],
                        ...
                        readonly=True,
                        hidden=True),
    Participants=dict(label=_(u'Players'),
                      hint=_(u'Number of participant players.'),
                      width=40,
                      readonly=True,
                      sortable=False)
    ))
...
def countries(request):
    ...
    # official ISO code...
    t = translator(request)
    result.append(dict(code="eur", name=t(_(u'Europe'))))
...
@expose(select([_ratings_t,
    ...
    Tourneys=dict(label=_(u'Tourneys'),
                 hint=_(u'Number of tourneys using this rating.'),
                 width=80,
                 readonly=True,
                 sortable=False),
    Players=dict(label=_(u'Players'),
                 hint=_(u'Number of rated players in this rating.'),
                 width=80,
                 readonly=True,
                 sortable=False)
    ))
...
_rated_players_metadata['CountRates'] = dict(
    label=_(u'Rates'),
    hint=_(u'Number of rates of the player.'),
    width=40,
)
