...
class BaseCommentNode(six.with_metaclass(RenameBaseCommentNodeMethods, template.Node)):
    ...
    def __init__(self, ctype=None, object_pk_expr=None, object_expr=None, as_varname=None, comment=None):
        ...
        self.comment_model = backtalk.get_model()
    ...
    def render(self, context):
        ...
        if object_pk:
            template_search_list = [
                "backtalk/%s/%s/form.html" % (ctype.app_label, ctype.model),
                "backtalk/%s/form.html" % ctype.app_label,
                "backtalk/form.html"
            ]
            context.push()
...
class RenderCommentListNode(CommentListNode):
    ...
    def render(self, context):
        ...
        if object_pk:
            template_search_list = [
                "backtalk/%s/%s/list.html" % (ctype.app_label, ctype.model),
                "backtalk/%s/list.html" % ctype.app_label,
                "backtalk/list.html"
            ]
            qs = self.get_queryset(context)
            context.push()
...
def render_comment_list(parser, token):
    ...
    through the ``backtalk/list.html`` template
...
def render_comment_form(parser, token):
    ...
    the ``backtalk/form.html`` template.
...
def comment_form_target():
    ...
    """
    return backtalk.get_form_target()
