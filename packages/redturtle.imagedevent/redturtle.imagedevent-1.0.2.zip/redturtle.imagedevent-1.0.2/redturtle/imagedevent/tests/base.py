...
def setup_product():
    ...
    import redturtle.imagedevent
    zcml.load_config('configure.zcml', redturtle.imagedevent)
    ...
    ztc.installPackage('redturtle.imagedevent')
...
setup_product()
ptc.setupPloneSite(products=['redturtle.imagedevent'])
