...
def setup_product():
    ...
    import pwrentch.FileReferences
    zcml.load_config('configure.zcml', pwrentch.FileReferences)
    ...
    ztc.installPackage('pwrentch.FileReferences')
...
setup_product()
ptc.setupPloneSite(products=['pwrentch.FileReferences'])
