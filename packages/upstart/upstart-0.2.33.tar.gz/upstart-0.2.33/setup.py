...
try:
      ...
      print("COULD NOT IMPORT VERSIONEER")
else:
      print("Visioneer imported.")
...
setup(distclass=Distribution,#VersionedDistribution,
      name='upstart',
      version='0.2.33',#None, #_VLazyVersion(), #versioneer.get_version(),
