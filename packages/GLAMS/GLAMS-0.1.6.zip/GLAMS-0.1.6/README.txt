...
TODO
=====
- When deactivating a cage or euthanizing a mouse, automatically fill in the date as today for date deactivated.
...
- Sometimes creates two 'housing' entries when dragging mouse from one cage to another
- Sometimes the refresh doesn't go through because when executing mysql command, "ReferenceError: weakly-referenced object no longer exists"
