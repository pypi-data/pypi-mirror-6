...
you can git clone from https://github.com/VanceKingSaxbeA/GoldSaxCreateTablesGFinance

by git clone https://github.com/VanceKingSaxbeA/GoldSaxCreateTablesGFinance.git

This is a dependancy Module to be used with GoldSaxEngine-******Markets. To Auto create tables based on source assets. 
pip install goldsaxgfinancequote before you can use it.
