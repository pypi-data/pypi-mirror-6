...
5.0) <http://msdn.microsoft.com/en-us/library/live/hh826521>`_ (formerly
known as SkyDrive).

API is mostly the same as in
`python-onedrive <https://github.com/mk-fg/python-onedrive>`_ module
...
docs <https://github.com/mk-fg/python-onedrive#command-line-usage>`_.
...
-  `python-onedrive <https://github.com/mk-fg/python-onedrive>`_
