...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('multilingual_orgs_organizationtranslation', 'multilingual_orgs_organizationtranslationrenamed')

    def backwards(self, orm):
        db.rename_table('multilingual_orgs_organizationtranslationrenamed', 'multilingual_orgs_organizationtranslation')
