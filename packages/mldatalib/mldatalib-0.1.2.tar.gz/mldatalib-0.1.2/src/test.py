...
def realstuff(attempt, predict=True):
    ...
    # traindata.delete_feature('skeleton')
    # traindata.delete_feature('hu')
    # traindata.delete_feature('daisy_feature')
    # traindata.delete_feature('zernike_mom')
    # traindata.delete_feature('erodes')
    # testdata.delete_feature('skeleton')
    # testdata.delete_feature('hu')
    # testdata.delete_feature('daisy_feature')
    # testdata.delete_feature('zernike_mom')
    # testdata.delete_feature('erodes')
