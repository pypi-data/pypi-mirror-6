# -*- coding: utf-8 -*-
'''
    (C) 2012-2014 Mike Miller.
    License: GNU GPLv3+

    A grab bag of assorted stuff.
'''
import sys, logging, hashlib, os, re, random, string
...
def crypt(passwd):
    ...
    try:
        ...
        try:
            from fcrypt import crypt as _crypt
            print '\nWarning: using non-native crypt support (fcrypt).'
        except ImportError:
            print '\nError: crypt support not available.  Install fcrypt:'
            print '       pip install fcrypt\n'
