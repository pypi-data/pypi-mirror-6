...
class BOMDownloadViewTestCase(ViewTestMixin, TestCase):
    """Tests for the ``BOMDownloadView`` view class."""
    longMessage = True
    ...
    def test_view(self):
        ...
        self.is_not_callable(kwargs={'cbom_pk': 123})
