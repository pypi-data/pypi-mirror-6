...
from twitter.pants.targets import JvmBinary, JvmTarget
...
class Project(object):
  ...
  def configure_profiles(self, scala_compiler_profile):
    _, self.checkstyle_classpath = profile_classpath('checkstyle')
    self.scala_compiler_classpath = []
    if self.has_scala:
      _, classpath = profile_classpath(scala_compiler_profile)
