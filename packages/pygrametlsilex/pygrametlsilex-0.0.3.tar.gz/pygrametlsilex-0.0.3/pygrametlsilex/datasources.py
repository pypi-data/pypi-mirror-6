...
if sys.platform.startswith('java'):
    ...
    from pygrametlsilex.jythonmultiprocessing import Queue, Process
else:
...
class CrossTabbingSource(object):
    ...
    def __init__(self, source, rowvaluesatt, colvaluesatt, values,
        ...
        - aggregator: the aggregator to use (see pygrametlsilex.aggregators). If not
          given, pygrametlsilex.aggregators.Sum is used to sum the values
        ...
        if aggregator is None:
            from pygrametlsilex.aggregators import Sum
