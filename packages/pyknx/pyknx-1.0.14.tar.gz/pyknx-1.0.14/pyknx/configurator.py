...
class Configurator:
    ...
    def generateConfig(self):
        ...
        if not configuredAtLeastOne:
            ...
            ioportNode.setAttribute('host', socket.gethostbyname(self._address[0])) #gethostbyname converts host to an ip. Linknx does not support hostnames.
    ...
    def writeConfig(self):
        outputXMLFile = codecs.open(self._outputFile, mode='w', encoding='utf8')
